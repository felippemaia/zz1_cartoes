					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gerar cartões Kanban",
									"targetURL": "#zz1cartoes-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zz1cartoes-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zz1cartoes",
									"url": sap.ui.require.toUrl("zz1cartoes")
								}
							}
						}
					}
